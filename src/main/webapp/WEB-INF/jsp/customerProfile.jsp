							...
							<div class="table-responsive">
								<table class="table table-user-information">
									<tbody>
										<tr>
											<td><strong> <i
													class="fas fa-user text-primary"></i> Name
											</strong></td>
											<td class="text-primary">${customer.name}</td>
										</tr>
										<tr>
											<td><strong> <i
													class="fas fa-envelope text-primary"></i> Email
											</strong></td>
										...
										<tr>
											<td><strong> <i
													class="fas fa-phone text-primary"></i> Phone
											</strong></td>
											<td class="text-primary">${customer.phone}</td>
										</tr>
										<tr>
											<td><strong> <i
													class="fas fa-home text-primary"></i> Address
											</strong></td>
