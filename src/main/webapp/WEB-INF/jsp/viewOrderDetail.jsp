...
<body>
											...
											<tbody>
												<tr>
													...
													<td><button type="button" class="btn btn-primary"
															...
															Order Confirm</button></td>
													<td><button type="button" class="btn btn-primary"
															data-toggle="modal" data-target="#cancelModal">
															Order Cancel</button></td>
												</tr>
											</tbody>
										</table>
									</div>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="confirmModalLabel">Order Confirm</h5>
					<button type="button" class="close" data-dismiss="modal"
						aria-label="Close">
						<span aria-hidden="true">&times;</span>
					</button>
				</div>
				<div class="modal-body">Are you sure to confirm this order?</div>
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary" onclick="orderConfirm()">OK</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal fade" id="cancelModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="submit" class="btn btn-primary" onclick="orderCancel()">OK</button>
				</div>
			</div>
		</div>
	</div>
	...
	<script>
		...
		function orderConfirm() {
			window.location.href = './orderConfirm/${bean.id}';
		}
		function orderCancel() {
			window.location.href = './orderCancel/${bean.id}';
		}
	</script>
</body>
</html>
